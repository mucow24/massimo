...
/**
 * The bold-ward tags and the rungs each one steps. Adding another is a line
 * here plus its name in `TAG_ALTS` — the stack, the innermost-wins rule, and
 * the resolver are already generic over the step count.
 */
