  ...
  return (
    <div className="canvas-host" data-uimode={selection.uiMode.kind}>
      ...
      >
        ...
        {/* Label-drag ghost lattice: candidate slots at the real station while
            the painted name is being dragged (idle mode). The layout-editor's
            own ghost lattice is painted with the rest of its focus content at
            the very end of the SVG. Pure chrome. */}
