 ...
 * segment is capped half a band-width past the end dot so the band visually
 * reaches the terminus. Pure — depends only on the line's station order, which
 * stations currently exist, and the per-segment styles.
 */
