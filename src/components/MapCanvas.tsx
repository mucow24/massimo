...
export function MapCanvas() {
  ...
  return (
    <div
      ...
      // and the paper disagree in both directions (an "Always dark" chrome over
      // a light map, a dimmed day paper under a light toolbar).
      ...
      // canvas color — not the chrome theme — so an "Always dark" chrome darkens
      // the toolbar/sidebar without leaking a black frame around a light map.
