...
// lifted out so it's DOM-free and unit-testable. The hook stays a thin stateful
// wrapper that reads one getBoundingClientRect per gesture event and delegates
// the arithmetic here.
