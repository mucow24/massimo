...
// toolbar's show/hide button, the canvas anchor layer, and the station layout
// editor's grab handle.
//
// Authored in a 15×15 box to match the @radix-ui/react-icons the rest of the
// toolbar uses, so the button reads as one of the set. The canvas scales the
// same paths by `size / ANCHOR_ICON_BOX` rather than re-drawing them at world
// scale — a second hand-tuned copy is exactly how two surfaces drift apart.
//
